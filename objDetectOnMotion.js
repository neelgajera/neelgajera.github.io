...
function drawBoxes(objects) {
	...
	objects.filter(object => object.line).forEach(object => {
        ...
        let startx = object.startx * drawCanvas.width;
        let starty = object.starty * drawCanvas.height;
		let endx = object.endx * drawCanvas.width;
        let endy = object.endy * drawCanvas.height;
        drawCtx.beginPath();
